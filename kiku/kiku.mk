...
CmpOptions             := -O2 $(shell /home/psc/src/wx291svn/bin/wx-config --cxxflags) $(shell /home/psc/11h11/oreilles/juliuscvs/bin/libjulius-config --cflags) $(shell /home/psc/11h11/oreilles/juliuscvs/bin/libsent-config --cflags) $(shell /usr/bin/xosd-config --cflags) $(Preprocessors)
C_CmpOptions           :=  $(Preprocessors)
LinkOptions            :=  -s $(shell /home/psc/src/wx291svn/bin/wx-config --libs) $(shell /home/psc/11h11/oreilles/juliuscvs/bin/libjulius-config --libs) $(shell /home/psc/11h11/oreilles/juliuscvs/bin/libsent-config --libs) $(shell /usr/bin/xosd-config --libs)
