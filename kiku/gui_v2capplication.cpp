...
gui_v2capplication::gui_v2capplication( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	b_editaction = new wxButton( this, wxID_ANY, _("Edit"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer41->Add( b_editaction, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5 );
	
	sb_edit->Add( bSizer41, 1, wxEXPAND|wxTOP|wxBOTTOM, 5 );
	
	mainSizer->Add( sb_edit, 1, wxEXPAND|wxALL, 5 );
	...
	fgSizer1->Add( tc_notification, 0, wxALIGN_CENTER_VERTICAL|wxTOP|wxBOTTOM|wxRIGHT, 5 );
	
	m_staticText5 = new wxStaticText( this, wxID_ANY, _("Pre-trigger:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText5->Wrap( -1 );
	fgSizer1->Add( m_staticText5, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxRIGHT|wxLEFT, 5 );
	
	tc_pretrig = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	tc_pretrig->Enable( false );
	
	fgSizer1->Add( tc_pretrig, 0, wxEXPAND|wxTOP|wxBOTTOM|wxRIGHT, 5 );
	...
	fgSizer1->Add( tc_trig, 0, wxEXPAND|wxTOP|wxBOTTOM|wxRIGHT, 5 );
	...
	fgSizer1->Add( tc_command, 0, wxALIGN_CENTER_VERTICAL|wxBOTTOM|wxRIGHT, 5 );
	
	sb_launcher->Add( fgSizer1, 1, wxEXPAND, 5 );
	
	mainSizer->Add( sb_launcher, 0, wxEXPAND|wxALL, 5 );
