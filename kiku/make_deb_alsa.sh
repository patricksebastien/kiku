...
Architecture: ${arch}
Essential: no
Depends: libx11-6, libc6, libgcc1, libstdc++6, libasound2, zlib1g, libexpat1, libtiff4, libjpeg62, libpng12-0, libsm6, libxxf86vm1, libglib2.0-0, libfontconfig1, libfreetype6, libpango1.0-0, libcairo2, libgtk2.0-0, libatk1.0-0, libxosd2, libxext6, libxinerama1, libnotify1, libdbus-glib-1-2, libdbus-1-3, libxtst6
...
cp ./Release-Alsa/${EXE_NAME} fakeroot/${PREFIX}/bin/kiku
cp /home/psc/11h11/code/julius/alsa/bin/mkss fakeroot/${PREFIX}/bin/kiku_mkss 
cp /home/psc/11h11/code/julius/alsa/bin/mkbinhmm fakeroot/${PREFIX}/bin/kiku_mkbinhmm 
cp /home/psc/11h11/code/julius/alsa/bin/mkbinhmmlist fakeroot/${PREFIX}/bin/kiku_mkbinhmmlist 
...
mv kiku_0.1-alsa0_i386.deb kiku_0.1-alsa_i386.deb
